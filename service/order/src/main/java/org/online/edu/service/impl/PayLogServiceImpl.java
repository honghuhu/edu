...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map<String, String> createNative(String orderNo) {
        try {
            ...
            m.put("notify_url", "http://.shop/api/order/weixinPay/weixinNotify\n");
            m.put("trade_type", "NATIVE");
            //2、HTTPClient来根据URL访问第三方接口并且传递参数
            //3、返回第三方的数据
            String xml = restTemplate.postForObject("https://api.mch.weixin.qq.com/pay/unifiedorder", WXPayUtil.generateSignedXml(m, "T6m9iK73b0kn9g5v426MKfHQH7X8rKwb"), String.class);
    ...
    public Map<String, String> queryPayStatus(String orderNo) {
        try {
            ...
            //2、设置请求
            //3、返回第三方的数据
            String xml = restTemplate.postForObject("https://api.mch.weixin.qq.com/pay/orderquery", WXPayUtil.generateSignedXml(m, "T6m9iK73b0kn9g5v426MKfHQH7X8rKwb"), String.class);
            //6、转成Map
            Map<String, String> resultMap = WXPayUtil.xmlToMap(xml);
            //7、返回
            return resultMap;
    ...
    public void updateOrderStatus(Map<String, String> map) {
        ...
        new LambdaUpdateChainWrapper<>(orderService.getBaseMapper()).set(Order::getStatus, 1).eq(Order::getOrderNo, orderNo).update();
        //记录支付日志
